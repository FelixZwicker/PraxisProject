...
public class WeaponUpgradeShop : MonoBehaviour
{
    ...
    private void Update()
    {
        WeaponUpgradeShopMoneyText.text = PlayerController.money.ToString();
    }
...
public class MachineGunDamageUpgradeItemOne : Items
{
    ...
    {
        GameObject machineGunBulletPrefab = Resources.Load("Prefab/Weapon/MashineGunBullet") as GameObject;
...
public class RocketLauncherDamageItemOne : Items
{
    ...
    public override void ItemEffect()
    {
        GameObject explosionBulletPrefab = Resources.Load("Prefab/Weapon/ExplosionBullet") as GameObject;
