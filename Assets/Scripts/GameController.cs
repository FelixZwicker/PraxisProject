...
public class GameController : MonoBehaviour
{
    ...
    void Start()
    {
        machineGunBulletPrefab = Resources.Load("Prefab/Weapon/MashineGunBullet") as GameObject;
        machineGunBulletScript = machineGunBulletPrefab.GetComponent<MashineGunBullet>();
        rocketLauncherPrefab = Resources.Load("Prefab/Weapon/ExplosionBullet") as GameObject;
